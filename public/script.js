...
// Test API connection
document.getElementById('testScamAPI')?.addEventListener('click', async function() {
    const btn = this;
    ...
    try {
        ...
        alert(`API Status: ${data.status}\nOpenAI: ${data.services.openai ? '✅ Ready' : '❌ Not configured'}\nGemini: ${data.services.gemini ? '✅ Ready' : '❌ Not configured'}`);
